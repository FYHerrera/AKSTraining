...
###############################################################################
LAB_NAME="advanced-troubleshooting"
...
EOF
    ...
    err "The application stack is completely broken!"
    info "There are 4 problems to find and fix."
    info "Start with: kubectl get all -n challenge"
    info "Use the DISCOVER framework."
}
